...
import ru.javaops.restaurantvoting.user.model.Role;
import ru.javaops.restaurantvoting.user.model.User;
import ru.javaops.restaurantvoting.user.repository.UserRepository;
...
import static ru.javaops.restaurantvoting.user.UserTestData.*;
import static ru.javaops.restaurantvoting.user.web.AdminUserController.REST_URL;
import static ru.javaops.restaurantvoting.user.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
