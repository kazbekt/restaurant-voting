...
import ru.javaops.restaurantvoting.user.to.UserTo;
import ru.javaops.restaurantvoting.user.util.UsersUtil;
...
import static ru.javaops.restaurantvoting.user.web.ProfileController.REST_URL;
